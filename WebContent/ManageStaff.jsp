...
<%   Cookie[] c=request.getCookies();
		...
		if(foundCookie)
		{
            ...
            {
                out.println("<script>document.getElementById('firsthead').innerHTML='Access Prohibited';");
                out.println("document.getElementById('addst').style.display = 'none';");
                out.println("document.getElementById('edit').style.display = 'none';");
                out.println("document.getElementById('rmv').style.display = 'none';");
